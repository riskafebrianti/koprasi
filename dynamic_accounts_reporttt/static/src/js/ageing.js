odoo.define('dynamic_accounts_reporttt.ageing', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'dynamic_accounts_reporttt.partner_ageing',
					'report_file': 'dynamic_accounts_reporttt.partner_ageing',
					'data': {
						'report_data': data
					},
					'context': {
