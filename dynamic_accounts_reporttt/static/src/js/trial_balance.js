odoo.define('dynamic_accounts_reporttt.trial_balance', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'dynamic_accounts_reporttt.trial_balance',
					'report_file': 'dynamic_accounts_reporttt.trial_balance',
					'data': {
						'report_data': data
					},
					'context': {
