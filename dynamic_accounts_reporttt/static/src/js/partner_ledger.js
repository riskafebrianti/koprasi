odoo.define('dynamic_accounts_reporttt.partner_ledger', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'dynamic_accounts_reporttt.partner_ledger',
					'report_file': 'dynamic_accounts_reporttt.partner_ledger',
					'data': {
						'report_data': data
					},
					'context': {
