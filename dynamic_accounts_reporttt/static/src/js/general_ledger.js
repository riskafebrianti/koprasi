odoo.define('dynamic_accounts_reporttt.general_ledger', function(require) {
	'use strict';
	...
	var QWeb = core.qweb;
	var _t = core._t;
	var trial = require('dynamic_accounts_reporttt.trial_balance');
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'dynamic_accounts_reporttt.general_ledger',
					'report_file': 'dynamic_accounts_reporttt.general_ledger',
					'data': {
						'report_data': data
					},
					'context': {
