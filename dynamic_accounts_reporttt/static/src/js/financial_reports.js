odoo.define('dynamic_accounts_reporttt.financial_reports', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'dynamic_accounts_reporttt.balance_sheet',
					'report_file': 'dynamic_accounts_reporttt.balance_sheet',
					'data': {
						'report_data': data,
